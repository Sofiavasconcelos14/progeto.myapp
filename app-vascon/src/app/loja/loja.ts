...
export class Loja {
  ...
  descricao: 'Um perfume suave e envolvente, trazendo delicadeza, elegância e conforto em cada borrifada.',
  preco: 200.0,
  imgs: ['image3.jpeg'],
  estoque: 15,
},
{
  ...
  descricao: ' Fresco e elegante, combina notas aquáticas com um fundo levemente amadeirado e sofisticado.',
  preco: 150.0,
  imgs: ['image4.jpeg'],
  estoque: 13,
},
...

{
  ...
  descricao: '   Quente e sedutor, com notas orientais que envolvem a pele como um abraço elegante.',
  preco: 175.0,
  imgs: ['image7.jpeg'],
  estoque: 16,
},
...

{
  ...
  descricao: '   Moderno e vibrante, combina frutas cítricas com um toque doce e energético marcante.',
  preco: 120.0,
...
adicionarAoCarrinho(prod: Produto) {
  this.carteService.adicionarcarrinho(prod);
